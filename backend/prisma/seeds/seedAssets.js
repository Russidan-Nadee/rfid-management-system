...
// Asset to Cost Center mapping (Complete data from cost ctrl asset number.txt)
const ASSET_COST_CENTER_MAP = {
  'C57385': '903100',
  'C58422': '200200',
  'C58423': '200200',
  'C58392': null,
...
function getCostCenterCode(assetNo) {
  if (!assetNo) return null;
  // Get cost center from mapping, return null if not found
  return ASSET_COST_CENTER_MAP[assetNo] || null;
}
...
async function seedAssets() {
  ...
  for (let i = 0; i < rawRows.length; i++) {
    ...
    const cost_center_code = getCostCenterCode(asset_no);
